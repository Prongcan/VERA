...
MASK_CONFIG = {(16,28), (29, 24),(11, 21),(13, 23),(14, 19)}
...
def main():
    ...
    # 数据集路径
    parser.add_argument("--data_path", type=str, default="data/docmath/docmath_sample.jsonl")
    # 结果保存路径
    parser.add_argument("--save_dir", type=str, default="tem/docmath_qwen_img_masked")
    ...
    for question in tqdm(questions):
        ...
        # 提取 Golden Evidence（DocMath 返回字符串）
        ...
        try:
            ...
            pred_entry = {
                ...
                "predicted_evidence": ""  # DocMath 标准通常是字符串
            }
