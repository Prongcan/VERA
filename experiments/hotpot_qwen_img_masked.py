...
from data.dataset_loader import HotpotLoader
# 导入文本转图片函数
...
MASK_CONFIG = {(29, 24), (11, 21),(10, 23),(18, 21),(30, 23)}
...
def main():
    ...
    # 数据集路径
    parser.add_argument("--data_path", type=str, default="data/hotpot/hotpot_dev_sample.jsonl")
    # 上下文目录路径
    parser.add_argument("--context_dir", type=str, default="data/hotpot/context")
    # 结果保存路径
    parser.add_argument("--save_dir", type=str, default="tem/hotpot_qwen_img_masked")
    ...
    loader = HotpotLoader(args.data_path, args.context_dir)
    ...
    for question in tqdm(questions):
        ...
        try:
            res = engine.run(prompt_context, question_text, image_paths, MASK_CONFIG)
            ...
            pred_entry = {
                ...
                "predicted_evidence": ""  # Hotpot 标准通常是列表，但这里按你要求设为字符串
            }
